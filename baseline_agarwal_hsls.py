...
def main():
    ...
    if fair_constraint == "acc":
        np.save('./result/result_hsls_race/acc/train_acc_agarwal.npy', train_acc_array)
        np.save('./result/result_hsls_race/acc/train_fair_agarwal.npy', train_fair_acc_array)
        np.save('./result/result_hsls_race/acc/test_acc_agarwal.npy', test_acc_array)
        np.save('./result/result_hsls_race/acc/test_fair_agarwal.npy', test_fair_acc_array)
        np.save('./result/result_hsls_race/acc/test_fair_0_agarwal.npy', test_fair_0_acc_array)
        np.save('./result/result_hsls_race/acc/test_fair_1_agarwal.npy', test_fair_1_acc_array)
    elif fair_constraint == "fpr":
        np.save('./result/result_hsls_race/fpr/train_acc_agarwal.npy', train_acc_array)
        np.save('./result/result_hsls_race/fpr/train_fair_agarwal.npy', train_fair_fpr_array)
        np.save('./result/result_hsls_race/fpr/test_acc_agarwal.npy', test_acc_array)
        np.save('./result/result_hsls_race/fpr/test_fair_agarwal.npy', test_fair_fpr_array)
        np.save('./result/result_hsls_race/fpr/test_fair_0_agarwal.npy', test_fair_0_fpr_array)
        np.save('./result/result_hsls_race/fpr/test_fair_1_agarwal.npy', test_fair_1_fpr_array)
    else:
        np.save('./result/result_hsls_race/fnr/train_acc_agarwal.npy', train_acc_array)
        np.save('./result/result_hsls_race/fnr/train_fair_agarwal.npy', train_fair_fnr_array)
        np.save('./result/result_hsls_race/fnr/test_acc_agarwal.npy', test_acc_array)
        np.save('./result/result_hsls_race/fnr/test_fair_agarwal.npy', test_fair_fnr_array)
        np.save('./result/result_hsls_race/fnr/test_fair_0_agarwal.npy', test_fair_0_fnr_array)
        np.save('./result/result_hsls_race/fnr/test_fair_1_agarwal.npy', test_fair_1_fnr_array)
