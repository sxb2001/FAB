...
def main():
    ...
    # EXP7/8/9: HSLS-race-fnr/acc/fpr
    ...
    np.save('./result/result_hsls_race/acc/test_acc_hardt.npy', test_acc_array)
    np.save('./result/result_hsls_race/acc/test_fair_hardt.npy', test_fair_acc_array)
    np.save('./result/result_hsls_race/acc/test_fair_0_hardt.npy', test_fair_0_acc_array)
    np.save('./result/result_hsls_race/acc/test_fair_1_hardt.npy', test_fair_1_acc_array)

    np.save('./result/result_hsls_race/fpr/test_acc_hardt.npy', test_acc_array)
    np.save('./result/result_hsls_race/fpr/test_fair_hardt.npy', test_fair_fpr_array)
    np.save('./result/result_hsls_race/fpr/test_fair_0_hardt.npy', test_fair_0_fpr_array)
    np.save('./result/result_hsls_race/fpr/test_fair_1_hardt.npy', test_fair_1_fpr_array)

    np.save('./result/result_hsls_race/fnr/test_acc_hardt.npy', test_acc_array)
    np.save('./result/result_hsls_race/fnr/test_fair_hardt.npy', test_fair_fnr_array)
    np.save('./result/result_hsls_race/fnr/test_fair_0_hardt.npy', test_fair_0_fnr_array)
    np.save('./result/result_hsls_race/fnr/test_fair_1_hardt.npy', test_fair_1_fnr_array)
